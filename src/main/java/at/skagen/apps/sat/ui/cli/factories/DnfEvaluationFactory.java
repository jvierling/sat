...
import at.skagen.apps.sat.ui.cli.printable.PrintableDnfEvaluation;
import at.skagen.apps.sat.ui.cli.printable.PrintableEvaluation;

public class DnfEvaluationFactory implements EvaluationFactory {
	...
	public PrintableEvaluation create(String[] args) throws FactoryException {
		...
		return new PrintableDnfEvaluation(formula);
	}
