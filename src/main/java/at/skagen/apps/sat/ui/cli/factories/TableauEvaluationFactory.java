...
import at.skagen.apps.sat.ui.cli.printable.PrintableTableauEvaluation;

public class TableauEvaluationFactory implements EvaluationFactory {
	...
	public PrintableEvaluation create(String[] args) throws FactoryException {
		...
		return new PrintableTableauEvaluation(formula);
	}
